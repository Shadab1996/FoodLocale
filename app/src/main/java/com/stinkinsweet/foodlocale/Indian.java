...
private Toolbar toolbar;
   private String post_key,cuisine,dish,latitude,longitude;
    ...
    private DatabaseReference databaseIndian;
  private  FirebaseRecyclerAdapter<Food, FoodViewHolder> firebaseRecyclerViewAdapter;
    ...
    protected void onStart() {
        ...
        progressDialog.setMessage("Indian dishes on the way...");
        progressDialog.show();

        firebaseRecyclerViewAdapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>
                (Food.class,
                        R.layout.food_row,
                        FoodViewHolder.class, databaseIndian
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            finish();
            startActivity(new Intent(Indian.this,Login.class));
