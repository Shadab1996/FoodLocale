...
public class South extends AppCompatActivity {
    ...
    private DatabaseReference databaseSouth;
    ...
    protected void onStart() {
        ...
        progressDialog.setMessage("Southern delights on the way...");
        progressDialog.show();

        firebaseRecyclerViewAdapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>
                (Food.class,
                        R.layout.food_row,
                        FoodViewHolder.class, databaseSouth
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            finish();
            startActivity(new Intent(South.this,Login.class));
