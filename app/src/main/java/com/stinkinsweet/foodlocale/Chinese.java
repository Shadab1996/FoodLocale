...
public class Chinese extends AppCompatActivity {
    ...
    private DatabaseReference databaseChinese;
    ...
    protected void onStart() {
        ...
        progressDialog.setMessage("Chinese dishes on the way...");
        progressDialog.show();

       firebaseRecyclerViewAdapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>
                (Food.class,
                        R.layout.food_row,
                        FoodViewHolder.class, databaseChinese
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            finish();
            startActivity(new Intent(Chinese.this,Login.class));
